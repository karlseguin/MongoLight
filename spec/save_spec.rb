...
describe 'save behavior' do
  ...
  it "normal saves the document using the aliased names" do
    expected = Factory.build(:simple, {:name => 'paul', :power => 49})
    expected.save
